    ...
    >
      ...
      <div className="w-full flex flex-col lg:flex-row items-stretch justify-between gap-8 lg:gap-10 pt-3">
        ...
        <div className="w-full lg:max-w-xl flex flex-col gap-4">
          ...
          <div className="bg-white/70 backdrop-blur-md border border-white/60 p-5 rounded-2xl shadow-xs flex flex-col gap-2">
            <div className="flex items-center gap-2.5 text-[#406BE0]">
              <BrainCircuit size={20} />
              <h3 className="font-bold text-zinc-900 text-base">Problem Solving</h3>
            </div>
          ...
          <div className="bg-white/70 backdrop-blur-md border border-white/60 p-5 rounded-2xl shadow-xs flex flex-col gap-2">
            <div className="flex items-center gap-2.5 text-[#406BE0]">
              <Database size={20} />
              <h3 className="font-bold text-zinc-900 text-base">System Design</h3>
            </div>
            <p className="text-sm text-zinc-500 font-medium pl-7">
          ...
          <div className="bg-white/70 backdrop-blur-md border border-white/60 p-5 rounded-2xl shadow-xs flex flex-col gap-2">
            <div className="flex items-center gap-2.5 text-[#406BE0]">
              <Cpu size={20} />
              <h3 className="font-bold text-zinc-900 text-base">Backend Engineering</h3>
            </div>
            <p className="text-sm text-zinc-500 font-medium pl-7">
          ...
          <div className="bg-white/70 backdrop-blur-md border border-white/60 p-5 rounded-2xl shadow-xs flex flex-col gap-2">
            <div className="flex items-center gap-2.5 text-[#406BE0]">
              <MonitorPlay size={20} />
              <h3 className="font-bold text-zinc-900 text-base">Frontend Craft</h3>
            </div>
            <p className="text-sm text-zinc-500 font-medium pl-7">
